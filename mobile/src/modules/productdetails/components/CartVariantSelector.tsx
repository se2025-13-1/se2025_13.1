...
const CartVariantSelector: React.FC<CartVariantSelectorProps> = ({
  ...
  const handleAddToCartPress = () => {
    ...
    console.log('handleAddToCartPress - selectedVariant:', selectedVariant);
    console.log('handleAddToCartPress - colorImages:', colorImages);
    ...
    onAddToCart(variantWithImages, quantity);
  };
